...
<div class="slider_top">
    <div class="swiper space_top space_bottom">
            ...
            <div class="swiper-slide">
                ...
                <div class="slide_filter">
                    <div class="slide-text">
                        <h1>Un accès sûr à l'eau</h1>
                        <h3>Des forages d'eau de qualité supérieure pour un accès ininterrompu à l'eau potable</h3>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
